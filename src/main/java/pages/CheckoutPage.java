...
public class CheckoutPage extends BasePage {
    ...
    private final By newAddressRadio =
    ...
    private final By existingAddressRadio =
            By.cssSelector("input[name='shipping_address'][value='existing']");
    ...
    // ----- Step 5: Confirm -----
    private final By confirmTotal =
            By.xpath("//table[@id='checkout-cart']//tr[td[contains(.,'Total')]]/td[2]");
    ...
    public void clickBillingContinue()  { click(billingContinue);  }
    ...
    public void clickShippingContinue() { click(shippingContinue); }

    public void enterDeliveryComment(String comment) {
        if (!comment.isEmpty()) type(deliveryComment, comment);
    }
    public void clickDeliveryContinue() { click(deliveryContinue); }

    public void agreeToTerms() { click(agreeTermsCheckbox); }
    public void clickPaymentContinue() { click(paymentContinue); }
